    ...
    async function loadEmployees() {
        ...
        table.innerHTML = employees.length ? '<div class="employee-tiles">' + employees.map(function (employee) {
            ...
            return [
                ...
                '<div class="employee-tile-row"><i class="ph ph-envelope"></i><span>' + utils.escapeHtml(employee.email) + '</span></div>',
                '<div class="employee-tile-row"><i class="ph ph-phone"></i><span>' + utils.escapeHtml(employee.phone || "—") + '</span></div>',
                '<div class="employee-tile-row"><i class="ph ph-calendar3"></i><span>' + utils.formatDate(employee.createdAt) + '</span></div>',
                '</div>',
